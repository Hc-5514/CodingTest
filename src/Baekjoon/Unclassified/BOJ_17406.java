...
public class BOJ_17406 {
    ...
    private static void Permutation(int cnt) {
        if (cnt == K) {
            ...
            for (int i = 0; i < K; i++) {
                int x1 = rotation[selectedNum[i]][0] - rotation[selectedNum[i]][2] - 1;
                int y1 = rotation[selectedNum[i]][1] - rotation[selectedNum[i]][2] - 1;
                int x2 = rotation[selectedNum[i]][0] + rotation[selectedNum[i]][2] - 1;
                int y2 = rotation[selectedNum[i]][1] + rotation[selectedNum[i]][2] - 1;
